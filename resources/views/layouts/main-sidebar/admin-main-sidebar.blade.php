    ...
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <li>
            ...
            <ul id="Accounts-menu" class="collapse" data-parent="#sidebarnav">
                ...
                <li> <a href="{{route('Fees_Invoices.index')}}">{{trans('invoice_trans.invoices')}}</a> </li>
                <li> <a href="{{route('receipt_students.index')}}">{{trans('catch_receipt_trans.receipts')}}</a> </li>
                <li> <a href="{{route('ProcessingFee.index')}}">{{trans('fee_exclusion_trans.fee_exclusion')}}</a> </li>
                <li> <a href="{{route('Payment_students.index')}}">{{trans('cashing_receipts_trans.cashing_receipts')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="library-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('library.index')}}">{{trans('main_trans.library_list')}}</a> </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
                <li> <a href="{{route('online_classes.index')}}">{{trans('main_trans.online_class_zoom')}}</a> </li>
            </ul>
        </li>
