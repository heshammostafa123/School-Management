...
@section('css')
    @toastr_css
@section('title')
    {{trans('catch_receipt_trans.receipt_edit')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
    {{trans('catch_receipt_trans.receipt_edit')}}: <label style="color: red">{{$receipt_student->student->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('catch_receipt_trans.amount')}} : <span class="text-danger">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('catch_receipt_trans.desc')}} : <span class="text-danger">*</span></label>
