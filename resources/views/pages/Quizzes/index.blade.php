                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('Quizzes.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{ trans('quizes_trans.add') }}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            <th>#</th>
                                            <th>{{ trans('quizes_trans.exam_name') }}</th>
                                            <th>{{ trans('quizes_trans.teacher_name') }}</th>
                                            <th>{{ trans('quizes_trans.grade') }}</th>
                                            <th>{{ trans('quizes_trans.class') }}</th>
                                            <th>{{ trans('quizes_trans.section') }}</th>
                                            <th>{{ trans('quizes_trans.processes') }}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 style="font-family: 'Cairo', sans-serif;"
                                                                    class="modal-title" id="exampleModalLabel">{{ trans('quizes_trans.delete') }}</h5>
