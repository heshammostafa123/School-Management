...
@section('css')
    @toastr_css
@section('title')
    {{trans('fee_exclusion_trans.fees_processing')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr class="alert-success">
                                            <th>#</th>
                                            <th>{{trans('fee_exclusion_trans.name')}}</th>
                                            <th>{{trans('fee_exclusion_trans.amount')}}</th>
                                            <th>{{trans('fee_exclusion_trans.desc')}}</th>
                                            <th>{{trans('fee_exclusion_trans.processes')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
