                        ...
                        <form class=" row mb-30" action="{{ route('Fees_Invoices.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="repeater">
                                    <div data-repeater-list="List_Fees">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name" class="mr-sm-2">{{trans('invoice_trans.student_name')}}</label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{trans('invoice_trans.fee_type')}}</label>
                                                    <div class="box">
                                                        <select class="fancyselect" name="fee_id" required>
                                                            <option value="">-- {{trans('invoice_trans.shoose')}} --</option>
                                                            @foreach($fees as $fee)
                                                ...
                                                <div class="col">
                                                    <label for="Name_en" class="mr-sm-2">{{trans('invoice_trans.amount')}}</label>
                                                    <div class="box">
                                                ...
                                                <div class="col">
                                                    <label for="description" class="mr-sm-2">{{trans('invoice_trans.desc')}}</label>
                                                    <div class="box">
                                    ...
                                    <button type="submit" class="btn btn-primary">{{trans('invoice_trans.data_confirmation')}}</button>
                                </div>
                            </div>
                        </form>
