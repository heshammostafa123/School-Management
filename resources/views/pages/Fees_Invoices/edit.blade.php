                    ...
                    <form action="{{route('Fees_Invoices.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{ trans('invoice_trans.student_name') }}</label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">{{ trans('invoice_trans.fee_type') }}</label>
                        ...
                        <div class="form-group">
                            <label for="inputAddress">{{ trans('invoice_trans.desc') }}</label>
