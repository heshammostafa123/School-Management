...
@section('css')
    @toastr_css
@section('title')
   {{ trans('questions_trans.questions_list') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                <a href="{{route('questions.create')}}" class="btn btn-success btn-sm" role="button"
                                   aria-pressed="true">{{ trans('questions_trans.add') }}</a><br><br>
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">{{ trans('questions_trans.correct_answer') }}</th>
                                            <th scope="col">{{ trans('questions_trans.degree') }}</th>
                                            <th scope="col">{{ trans('questions_trans.exam_name') }}</th>
