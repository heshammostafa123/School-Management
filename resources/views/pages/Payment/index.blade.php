...
@section('css')
    @toastr_css
@section('title')
{{trans('cashing_receipts_trans.cashing_receipts')}} 
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr class="alert-success">
                                            <th>#</th>
                                            <th>{{trans('cashing_receipts_trans.name')}}</th>
                                            <th>{{trans('cashing_receipts_trans.amount')}}</th>
                                            <th>{{trans('cashing_receipts_trans.desc')}}</th>
                                            <th>{{trans('cashing_receipts_trans.processes')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
