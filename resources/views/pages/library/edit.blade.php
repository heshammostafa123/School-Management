...
@section('css')
    @toastr_css
@section('title')
{{ trans('library_trans.edit') }} {{$book->title}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('library.update','test')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">{{ trans('library_trans.ref_name') }}</label>
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{ trans('library_trans.confirm') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
